/*流星背景效果*/
		var WINDOW_WIDTH = $(".foureKpageBox").width();
		var WINDOW_HEIGHT = $(".foureKpageBox").height();
		var canvas,context;
		var num = 500;
		var stars = [];
		...
		var rnd;
		console.log('打印' + WINDOW_WIDTH,WINDOW_HEIGHT);
		window.onload = function(){
			canvas = document.getElementById('liu-canvas');
		...
		function render(){
			context.fillStyle = 'rgba(6,18,69,13)';
